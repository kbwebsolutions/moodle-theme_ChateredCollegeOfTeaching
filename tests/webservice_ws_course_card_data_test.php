 ...
 */
class theme_charteredcollege_ws_course_card_data_test extends \advanced_testcase {

    public function test_service_parameters() {
        $params = \theme_charteredcollege\webservice\ws_course_cards_data::service_parameters();
        $this->assertTrue($params instanceof external_function_parameters);
    }

    public function test_service_returns() {
        $returns = \theme_charteredcollege\webservice\ws_course_cards_data::service_returns();
    ...
    public function test_service() {
        ...
        $serviceresult = \theme_charteredcollege\webservice\ws_course_cards_data::service(0, 'current');
