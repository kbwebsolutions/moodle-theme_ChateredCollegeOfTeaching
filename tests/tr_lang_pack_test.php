...
class theme_charteredcollege_tr_lang_pack_test extends advanced_testcase  {
    public function test_tr_lang_pack_correct() {
        global $CFG;

        $strfile = file_get_contents($CFG->dirroot . '/theme/charteredcollege/cli/trstrings.json');
        ...
        $string = [];
        $discrepancies = 0;
        $langfilelocation = $CFG->dirroot . '/theme/charteredcollege/lang/tr/theme_charteredcollege.php';
        ...
        $message .= 'Make sure you run theme/charteredcollege/cli/fix_tr_lang_strings.php to fix them.';
