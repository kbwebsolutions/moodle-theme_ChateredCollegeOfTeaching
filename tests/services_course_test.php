 ...
 */
class theme_charteredcollege_services_course_test extends \advanced_testcase {
    ...
    public function test_course_toc() {
        ...
        $this->assertTrue($toc->modules[0] instanceof theme_charteredcollege\renderables\course_toc_module);
        $this->assertTrue($toc->modules[0]->url === '#section-0&module-'.$page->cmid);
        $this->assertTrue($toc instanceof theme_charteredcollege\renderables\course_toc);
    ...
    public function test_course_toc_chapters() {
        ...
        $this->assertTrue($chapters->chapters[0] instanceof theme_charteredcollege\renderables\course_toc_chapter);
    }
    ...
    public function test_course_toc_chapters_escaped_chars() {
        ...
        $tochtml = $OUTPUT->render_from_template('theme_charteredcollege/course_toc_chapters',
    ...
    public function test_highlight_section() {
        ...
        $toc = $highlight['toc'];
        $this->assertTrue($actionmodel instanceof theme_charteredcollege\renderables\course_action_section_highlight);
        $this->assertTrue($toc instanceof theme_charteredcollege\renderables\course_toc);
    ...
    public function test_set_section_visibility() {
        ...
        $toc = $visibility['toc'];
        $this->assertTrue($actionmodel instanceof theme_charteredcollege\renderables\course_action_section_visibility);
        $this->assertTrue($toc instanceof theme_charteredcollege\renderables\course_toc);

        // Check that action model has toggled after section hidden.
        $this->assertEquals('charteredcollege-visibility charteredcollege-show', $actionmodel->class);
        ...
        // Check that action model now corresponds to unhighlighted state.
        $this->assertEquals('charteredcollege-visibility charteredcollege-hide', $actionmodel->class);
    ...
    public function test_section_fragment() {
        ...
        $section = theme_charteredcollege_output_fragment_section($params);
        $this->assertContains('aria-label="Topic 1"', $section);
        // Section doesn't have the modchooser div.
        $this->assertNotContains('charteredcollege-modchooser', $section);
        ...
        $section = theme_charteredcollege_output_fragment_section($params);
        $this->assertContains('Fragment forum', $section);
        $this->assertContains('charteredcollege-modchooser', $section);
    }
}
