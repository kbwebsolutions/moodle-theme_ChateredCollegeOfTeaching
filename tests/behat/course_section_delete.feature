...
Feature: When the moodle theme is set to charteredcollege, teachers can delete sections without having to reload the page.
  ...
  Scenario Outline: In read mode, on course, teacher can cancel / confirm delete section.
    ...
    When I click on "#section-1 .charteredcollege-section-editing.actions a.charteredcollege-delete" "css_element"
  ...
  Scenario Outline: Student cannot delete section.
    ...
    And I am on the course main page for "C1"
    And I follow "Topic 1"
    Then "#section-1 .charteredcollege-section-editing.actions a.charteredcollege-delete" "css_element" should not exist
  Examples:
    | Option     |
    | 0          |
    | 1          |
