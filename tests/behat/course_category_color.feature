...
Feature: When the moodle theme is set to charteredcollege, admins can change the color for a given category.
  ...
  @javascript
  Scenario: Go to charteredcollege settings page and put a wrong JSON text in it.
  ...
  @javascript
  Scenario: Go to charteredcollege settings page and put a valid JSON text in it.
    Given I log in as "admin"
    And I am on site homepage
    And I click on "#admin-menu-trigger" "css_element"
    And I expand "Site administration" node
  ...
  @javascript
  Scenario: Go to charteredcollege settings page and put a valid JSON text in it but with no existing categories.
    Given I log in as "admin"
    And I am on site homepage
    And I click on "#admin-menu-trigger" "css_element"
    And I expand "Site administration" node
  ...
  @javascript
  Scenario: Go to charteredcollege settings page and put a not valid color in the JSON text.
    Given I log in as "admin"
    And I am on site homepage
    And I click on "#admin-menu-trigger" "css_element"
    And I expand "Site administration" node
  ...
  @javascript
  Scenario: Go to charteredcollege settings page and put a wrong JSON text with duplicated IDs.
    Given I log in as "admin"
    And I am on site homepage
    And I click on "#admin-menu-trigger" "css_element"
    And I expand "Site administration" node
