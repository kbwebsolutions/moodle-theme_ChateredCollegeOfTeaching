...
/**
 * Overrides to make behat navigation work with charteredcollege.
 *
 * @author    Guy Thomas <osdev@blackboard.com>
 * @copyright Copyright (c) 2017 Blackboard Inc.
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_theme_charteredcollege_behat_navigation extends behat_navigation {
...
EOF;
     ...
     * the moodle core step doesn't work on charteredcollege, so a minor
    ...
    /**
     * Just go to the course page as charteredcollege doesn't have the same concept of editing mode.
     */
    public function i_am_on_course_homepage_with_editing_mode_on($coursefullname) {
        // charteredcollege doesn't really have the concept of edit mode.
