...
#
# Tests for course progress in the charteredcollege personal menu.
#
...
Feature: When the moodle theme is set to charteredcollege, students and teachers can open a personal menu which features a
