 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_theme_charteredcollege_behat_general extends behat_general {
     ...
     *
     */
    public function theme_charteredcollege_should_appear_before($preelement, $preselectortype, $postelement, $postselectortype) {
