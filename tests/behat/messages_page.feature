...
@theme @theme_charteredcollege @charteredcollege_message
Feature: When the Moodle theme is set to charteredcollege, message page should be accessible.
  ...
  Scenario: In messages page, it must be possible to click the items.
    ...
    And I click on "//a[small[contains(@id, \"charteredcollege-pm-messages\")]]" "xpath_element"
  ...
  Scenario: In personal menu preferences page, it must be possible to click the items.
    ...
    And I am on site homepage
    And I click on ".js-charteredcollege-pm-trigger.charteredcollege-my-courses-menu" "css_element"
    And I click on "//a[@id='charteredcollege-pm-preferences']" "xpath_element"
    And I follow "Message preferences"
  ...
  Scenario: When selecting messages in profile, a new messages window opens.
    ...
    And I click on "//a[@id='charteredcollege-pm-profile']" "xpath_element"
    And I wait until the page is ready
