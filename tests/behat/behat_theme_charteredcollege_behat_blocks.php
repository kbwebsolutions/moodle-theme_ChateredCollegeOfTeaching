...
/**
 * Overrides to make behat block steps work with charteredcollege.
 *
 * @copyright Copyright (c) 2017 Blackboard Inc.
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_theme_charteredcollege_behat_blocks extends behat_blocks {

    public function i_add_the_block($blockname) {
        // Enter block editing mode before adding tbe block, then leave it.
        // Core tests expect you to have enabled edit mode in advance, but charteredcollege
