...
Feature: When the Moodle theme is set to charteredcollege, personal menu and course mod chooser should be accessible tabs.
  ...
  Scenario: Personal menu tab should have a specific aria-controls attribute to be accessible.
    ...
    And the "aria-controls" attribute of "#charteredcollege-pm-accessible-tab a#charteredcollege-pm-tab-current" "css_element" should contain "charteredcollege-pm-courses-current"
