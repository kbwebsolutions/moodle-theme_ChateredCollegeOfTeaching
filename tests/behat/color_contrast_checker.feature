...
Feature: When the moodle theme is set to charteredcollege, a color contrast checker can be viewed.
  ...
  @javascript
  Scenario: Go to charteredcollege settings page, put a color in theme color and see contrast message.
  ...
  @javascript
  Scenario: Go to charteredcollege settings page, put a valid JSON text in it and see contrast message.
    Given I log in as "admin"
    And I am on site homepage
    And I click on "#admin-menu-trigger" "css_element"
    And I expand "Site administration" node
  ...
  @javascript
  Scenario: Go to charteredcollege settings page, put a valid JSON text in it and don't see contrast message.
    Given I log in as "admin"
    And I am on site homepage
    And I click on "#admin-menu-trigger" "css_element"
    And I expand "Site administration" node
