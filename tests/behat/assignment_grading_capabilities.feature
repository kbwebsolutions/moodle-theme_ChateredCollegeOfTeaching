...
@theme @theme_charteredcollege @theme_charteredcollege_grading
Feature: When the moodle theme is set to charteredcollege, grading activities are shown only if user have grading capabilities.
