...
#
# Tests for course favoriting in the charteredcollege personal menu.
#
...
Feature: When the moodle theme is set to charteredcollege, expired courses appear in an archive section within the personal menu.
  ...
  Scenario: User can navigate to and from archived courses sections.
    ...
    And I click on "#charteredcollege-pm-tab-current" "css_element"
    And I should not see "Past-course 1"
    And I should not see "Past-course 2"
    And I should not see "Past-course 3"
