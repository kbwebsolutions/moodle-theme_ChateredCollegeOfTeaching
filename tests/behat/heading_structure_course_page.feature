...
@mod @mod_hsuforum @theme @theme_charteredcollege
Feature: With a discussion created, the heading levels structure should be correct on course page.
  ...
  Scenario: Heading levels should be correct.
    ...
    And I am on "Course 1" course homepage
    And ".section li.charteredcollege-activity.modtype_hsuforum .charteredcollege-asset-content .charteredcollege-asset-meta .hsuforum-recent .charteredcollege-media-object .charteredcollege-media-body h5" "css_element" should exist
    And "#charteredcollege-course-footer-recent-activity .hsuforum-recent h4" "css_element" should exist
