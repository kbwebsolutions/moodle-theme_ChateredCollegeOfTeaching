...
Feature: When the moodle theme is set to charteredcollege, the admin block will only be shown when appropriate.
  ...
  @javascript
  Scenario: User with the moodle/site:configview capability should be able to see the charteredcollege gear icon.
