...
Feature: When theme is set to charteredcollege, and course:activityvisibility is set for students, a student should be able to hide an activity.
  ...
  Scenario: Student should not see the activity after hiding it
    ...
    And I wait until ".charteredcollege-activity[data-type='Assignment'] span.charteredcollege-edit-asset-more" "css_element" is not visible
  ...
  Scenario: Student should not be able to hide an activity if the course doesn't have course:activityvisibility for students
    Given I log in as "student1"
    And I am on "Course 1" course homepage
    And ".charteredcollege-activity[data-type='Assignment'] span.charteredcollege-edit-asset-more" "css_element" should not exist
