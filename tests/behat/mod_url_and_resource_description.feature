...
@theme @theme_charteredcollege @_file_upload
Feature: When the moodle theme is set to charteredcollege, the users see an intermediate page to display the description in mod_url and mod_resource.
  ...
  Background:
    ...
    And the following config values are set as admin:
      ...
      | displaydescription | 1    | theme_charteredcollege |
  ...
  Scenario: As a teacher I should see an intermediate page with the description in mod_url.
    ...
    And the following config values are set as admin:
      | resourcedisplay | list | theme_charteredcollege |
    And I am on "Course 1" course homepage
    And I wait until the page is ready
    And I click on ".modtype_url a.mod-link" "css_element"
