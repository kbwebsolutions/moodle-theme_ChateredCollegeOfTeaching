...
Feature: A student should not see any recent forum activity
  ...
  @javascript
  Scenario: Student2 should see recent activity made in Forums on charteredcollege personal menu
  ...
  @javascript
  Scenario: Student3 should not see recent activity made in Forums on charteredcollege personal menu
  ...
  @javascript
  Scenario: Student1 should not see recent activity made in Open Forums on charteredcollege personal menu
  ...
  @javascript
  Scenario: Student4 should see recent activity made in Open Forums on charteredcollege personal menu
