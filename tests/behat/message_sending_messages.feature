...
#
# Tests for sending messages in charteredcollege.
#
...
Feature: charteredcollege message send messages
  As a user
  ...
  Scenario: Send a message to a group conversation in charteredcollege
  ...
  Scenario: Send a message to a starred conversation in charteredcollege
    Given I log in as "student1"
    And I am on site homepage
    And I click on ".js-charteredcollege-pm-trigger.charteredcollege-my-courses-menu" "css_element"
    And I follow "View my messages"
  ...
  Scenario: Send a message to a private conversation via contacts in charteredcollege
  ...
  and should redirect to the message page.
    ...
    And I log in as "student2"
    And I am on site homepage
    And "#mr-nav .badge-count-container .charteredcollege-message-count" "css_element" should exist
    And "//a[@class='charteredcollege-message-count']//div[text()='2']" "xpath_element" should exist
    And the "aria-label" attribute of "#mr-nav .badge-count-container .charteredcollege-message-count i.icon.fa-comment" "css_element" should contain "Open messaging drawer. There are 2 unread conversations"
    And I click on "#mr-nav .badge-count-container .charteredcollege-message-count" "css_element"
    And I should see "(2)" in the ".section[data-region='view-overview-messages']" "css_element"
    And I should see "2" in the ".badge-primary[data-region='section-unread-count'][aria-label='There are 2 unread conversations']" "css_element"
    ...
    Then I should see "Hi!" in the ".d-flex[data-region='day-messages-container']" "css_element"
    And I am on site homepage
    And the "aria-label" attribute of "#mr-nav .badge-count-container .charteredcollege-message-count i.icon.fa-comment" "css_element" should contain "Open messaging drawer. There are 0 unread conversations"

  @javascript
  Scenario: Message icon should change its color when the category color changes.
    Given the following config values are set as admin:
      | category_color | {"5":"#510038"} | theme_charteredcollege |
