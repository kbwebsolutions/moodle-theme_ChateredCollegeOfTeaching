...
@theme @theme_charteredcollege @theme_charteredcollege_grading @theme_charteredcollege_course
Feature: When the moodle theme is set to charteredcollege, a course tools section is available and it should display correctly
