...
Feature: When the moodle theme is set to charteredcollege, cover image can be set for site and courses.
  ...
  Scenario: Editing teachers can change and delete course cover image.
    ...
    And I wait until "label[for=\"charteredcollege-coverfiles\"]" "css_element" is visible
