...
#
# Tests for charteredcollege personal menu.
#
...
Feature: When the moodle theme is set to charteredcollege, students and teachers can find in their personal menu a list of deadlines
  ...
  Background:
    ...
    And the following "courses" exist:
      ...
      | Course 1 | C1        | 0        | 1         |       | 0                 |
      | Course 2 | C2        | 0        | 1         | charteredcollege  | 1                 |
  ...
  Scenario Outline: Student sees correct submission status against deadlines when 1 out of 2 assignments are submitted by student.
    ...
    And the following config values are set as admin:
      | personalmenuadvancedfeedsenable | <enadvfeeds> | theme_charteredcollege |
    And I log in as "student1"
    And I <waitclause>
    And I open the personal menu
    And I should see "Not Submitted" in the "#charteredcollege-personal-menu-<selectorstr> div.charteredcollege-media-object:first-of-type" "css_element"
    And I should see "Not Submitted" in the "#charteredcollege-personal-menu-<selectorstr> div.charteredcollege-media-object:nth-of-type(2)" "css_element"
    ...
    And I <waitclause>
    And I open the personal menu
    And I should see "Submitted" in the "#charteredcollege-personal-menu-<selectorstr> div.charteredcollege-media-object:first-of-type" "css_element"
    And I should not see "Not Submitted" in the "#charteredcollege-personal-menu-<selectorstr> div.charteredcollege-media-object:first-of-type" "css_element"
    And I should see "Not Submitted" in the "#charteredcollege-personal-menu-<selectorstr> div.charteredcollege-media-object:nth-of-type(2)" "css_element"
    ...
    Examples:
      ...
      | 1          | feed-deadlines  | wait until "charteredcollege-feed" custom element is registered |
  ...
  Scenario Outline: Teacher sees no submission status data against deadlines.
    ...
    And I <waitclause>
    And I open the personal menu
    And I should not see "Submitted" in the "#charteredcollege-personal-menu-<selectorstr> div.charteredcollege-media-object:first-of-type" "css_element"
    And I should not see "Not Submitted" in the "#charteredcollege-personal-menu-<selectorstr> div.charteredcollege-media-object:first-of-type" "css_element"
    And I should not see "Submitted" in the "#charteredcollege-personal-menu-<selectorstr> div.charteredcollege-media-object:nth-of-type(2)" "css_element"
    And I should not see "Not Submitted" in the "#charteredcollege-personal-menu-<selectorstr> div.charteredcollege-media-object:nth-of-type(2)" "css_element"
    And Activity "assign" "Test assignment1" is deleted
    And Activity "assign" "Test assignment2" is deleted
    Examples:
      | enadvfeeds | selectorstr     | waitclause                                          |
  ...
  @javascript
  Scenario Outline: Student sees correct submission status when the platform theme is different from charteredcollege and the course is forced to charteredcollege
    Given the following config values are set as admin:
      | theme | classic |
    Given the following "activities" exist:
      | activity | course | idnumber | name             | intro             | assignsubmission_onlinetext_enabled | assignfeedback_comments_enabled | section | duedate         |
  ...
  Scenario Outline: Extended deadline dates take priority over deadlines.
    ...
    Examples:
      ...
      | 1          | wait until "charteredcollege-feed" custom element is registered |
  ...
  Scenario Outline: Expected completed on activities that do not have due date are shown on deadlines
    ...
    And the following config values are set as admin:
      | personalmenuadvancedfeedsenable  | <enadvfeeds> | theme_charteredcollege |
      | personalmenuadvancedfeedsperpage | 5 | theme_charteredcollege |
    And I log in as "teacher1"
  ...
  Scenario Outline: As student i shouln't see deadlines of activities in the recycle bin.
    ...
    And I <waitclause>
    And I open the personal menu
    And "#charteredcollege-personal-menu-<selectorstr> div.charteredcollege-media-object:first-of-type" "css_element" should not exist
    Examples:
      | enadvfeeds | selectorstr     | waitclause                                          |
      | 0          | deadlines       | wait until the page is ready                        |
      | 1          | feed-deadlines  | wait until "charteredcollege-feed" custom element is registered |
