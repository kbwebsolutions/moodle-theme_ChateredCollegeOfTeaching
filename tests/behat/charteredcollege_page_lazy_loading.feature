...
@theme @theme_charteredcollege @theme_charteredcollege_lazy_loading @charteredcollege_page_resource
Feature: When the moodle theme is set to charteredcollege course pages can be rendered using lazy loading.
  Background:
  ...
  Scenario Outline: Check if Page content is being lazy loaded
    Given the following config values are set as admin:
      | lazyload_mod_page | <lazyload> | theme_charteredcollege |
