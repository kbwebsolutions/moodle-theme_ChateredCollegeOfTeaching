...
@theme @theme_charteredcollege @theme_charteredcollege_quiz
Feature: Quiz attempts from suspended users and previews from admin or teachers
  ...
  Scenario: Student sees correct meta data against quiz activities
    ...
    And ".charteredcollege-completion-meta a" "css_element" should exist
    And I should see "0 of 2 Attempted"
    And I log out
    And I log in as "student1"
    And I am on "Course 1" course homepage
    And I click on ".charteredcollege-asset-link a" "css_element"
