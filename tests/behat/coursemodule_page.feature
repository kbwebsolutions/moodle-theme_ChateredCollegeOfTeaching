...
@theme @theme_charteredcollege @charteredcollege_page_resource
Feature: Open page module inline
  ...
  Background:
    ...
    And the following config values are set as admin:
      | lazyload_mod_page | 0 | theme_charteredcollege |
  ...
  Scenario Outline: Page mod is created and opened inline.
    ...
    And the following config values are set as admin:
      ...
      | design_mod_page     | 1        | theme_charteredcollege |
  ...
  Scenario Outline: Page mod completion updates on read more and affects availability for other modules and sections.
    ...
    And the following config values are set as admin:
      | coursepartialrender | <Option>   | theme_charteredcollege |
      | resourcedisplay     | <Option 2> | theme_charteredcollege |
      | design_mod_page     | 1          | theme_charteredcollege |
    And I am on the course main page for "C1"
    ...
    And I click on "//a[@class='charteredcollege-conditional-tag']" "xpath_element"
    And I should see "Not available unless: The activity Page completion is marked complete"
    And I follow "Topic 1"
    And "#chapters li:nth-of-type(2).charteredcollege-visible-section" "css_element" should exist
    ...
    And "#chapters li:nth-of-type(1).charteredcollege-visible-section" "css_element" should exist
  ...
  Scenario Outline: Page mod is opened in a new window by default.
    ...
    Examples:
      ...
      | li[data-type='Page'] h3.charteredcollege-asset-link a.mod-link p.instancename |
