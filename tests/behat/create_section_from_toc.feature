...
@theme @theme_charteredcollege @theme_charteredcollege_course_section
Feature: In the charteredcollege theme, within a course, editing teachers can create a new section by clicking on a
