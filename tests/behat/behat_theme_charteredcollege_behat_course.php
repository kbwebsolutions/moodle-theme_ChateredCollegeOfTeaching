...
/**
 * Overrides to make behat course steps work with charteredcollege.
 *
 * @copyright Copyright (c) 2017 Blackboard Inc.
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_theme_charteredcollege_behat_course extends behat_course {
    ...
    public function i_add_to_section($activity, $section) {
        ...
        $xpath = "//*[@id='charteredcollege-modchooser-modal']//a[text()='$activity']";
