...
Feature: When the moodle theme is set to charteredcollege, students and teachers can open a personal menu where they can find
  ...
  Scenario Outline: Enrolled courses show grade in personal menu when enabled.
    ...
    And the following config values are set as admin:
      | showcoursegradepersonalmenu | <showgrades> | theme_charteredcollege |
