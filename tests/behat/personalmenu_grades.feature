...
@theme @theme_charteredcollege @_bug_phantomjs @theme_charteredcollege_personalmenu @theme_charteredcollege_grading
Feature: When the moodle theme is set to charteredcollege, students and teachers can open a personal menu which shows a
  ...
  Scenario Outline: 1 out of 2 assignments are submitted by student and graded by teacher.
   ...
   When I follow "Add submission"
    ...
    And I log in as "teacher1"
    And I open the personal menu
    And I wait until "#charteredcollege-personal-menu-<dataloadselectorstr>" "css_element" is visible
    # The above waits until the charteredcollege personal menu column is loaded.
   ...
   Then I should see "You have no submissions to grade."
    ...
    And I log in as "student1"
    And I open the personal menu
    And I should see "Test assignment1" in the "#charteredcollege-personal-menu-<selectorstr>" "css_element"
    And I should see "Feedback"
    And Activity "assign" "Test assignment1" is deleted
    And Activity "assign" "Test assignment2" is deleted
    Examples:
  ...
  @javascript
    Scenario: Show grading in the personal menu only to the teachers with the proper access to the courses or the groups.
      ...
      And I open the personal menu
      And I wait until "#charteredcollege-personal-menu-grading[data-content-loaded=\"1\"]" "css_element" is visible
     Then I should see "You have no submissions to grade."
