...
use theme_charteredcollege\user_forums;
use core_component;
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_charteredcollege_recent_forum_activity_test extends \advanced_testcase {
    ...
    public function test_forum_high_volume_posts($ftype = 'forum') {
        ...
        if (get_class($this) === "theme_charteredcollege\\tests\\theme_charteredcollege_recent_forum_activity_test") {
