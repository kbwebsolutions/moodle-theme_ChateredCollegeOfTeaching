...
namespace theme_charteredcollege\tests\renderables;
...
class featured_courses_test extends \advanced_testcase {
    ...
    public function test_featured_courses() {
        ...
        set_config('fc_one', $course1->id, 'theme_charteredcollege');
        set_config('fc_two', $course2->id, 'theme_charteredcollege');
        set_config('fc_three', $course3->id, 'theme_charteredcollege');
        set_config('fc_four', $course4->id, 'theme_charteredcollege');
        $fc = new featured_courses();
