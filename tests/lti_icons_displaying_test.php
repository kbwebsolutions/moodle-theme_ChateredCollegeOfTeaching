...
/**
 * LTI icons displaying correctly in charteredcollege.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_charteredcollege_lti_icons_displaying extends advanced_testcase {
    /**
     * Setup for each test.
     */
    ...
    /**
     * Tests that both possible LTI icons are displayed in charteredcollege.
     */
    public function test_lti_icons_are_displayed() {
        ...
        $ltiregularicon = '<img src="https://www.example.com/moodle/theme/image.php/_s/charteredcollege/lti/1/icon" class="svg-icon" alt="" role="presentation"><br>Test tool';
