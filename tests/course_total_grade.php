...
use theme_charteredcollege\course_total_grade;
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_charteredcollege_course_total_grade_test extends \advanced_testcase {
    ...
    public function test_performance() {
        ...
        $newtime = $this->run_performance_test($title, 'theme_charteredcollege\local::course_grade', []);
