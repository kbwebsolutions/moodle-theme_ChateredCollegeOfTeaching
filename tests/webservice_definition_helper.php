...
use theme_charteredcollege\webservice\definition_helper;
 ...
 */
class theme_charteredcollege_webservice_definition_helper_test extends advanced_testcase {
...
EOF;
    ...
    public function test_cache_definition() {
        ...
        $cache = cache::make('theme_charteredcollege', 'webservicedefinitions');
