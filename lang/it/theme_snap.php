...
$string['cachedef_generalstaticappcache'] = 'Cache livello applicazione statica generale charteredcollege';
...
$string['courseformatnotification'] = 'L\'attuale formato del corso in uso non è completamente supportato dal tema charteredcollege. Per un\'esperienza ottimale, Open LMS consiglia di utilizzare gli argomenti o i formati del corso settimanale con il tema charteredcollege. È possibile modificare il formato del corso nelle <a href="{$a}">impostazioni del corso</a>.';
...
$string['privacy:metadata:theme_cct_course_favorites:courseid'] = 'ID del corso che l\'utente ha contrassegnato come preferito';
$string['privacy:metadata:theme_cct_course_favorites:userid'] = 'L\'ID utente dell\'utente che ha contrassegnato come preferito il corso';
$string['privacy:metadata:theme_cct_course_favorites:timefavorited'] = 'Timestamp che indica quando l\'utente ha contrassegnato come preferito il corso';
$string['privacy:metadata:theme_cct_course_favorites'] = 'Memorizza i preferiti del corso degli utenti per charteredcollege';
...
$string['resourcedisplayhelp'] = 'Seleziona la modalità di visualizzazione di allegati e collegamenti nel corso. Il tema charteredcollege non supporta file multimediali nella scheda descrizione attività e risorse.';
...
$string['showallsectionsdisabled'] = 'Per via della sua lingua di progettazione, "Visualizza le sezioni nella stessa pagina" non è disponibile in charteredcollege.';
$string['disabled'] = 'Disabilitato';
$string['showappearancedisabled'] = 'La lingua di progettazione di charteredcollege impedisce le modifiche alle impostazioni di "Aspetto".';
...
<li>La stringa <code>charteredcollege-pbb-</code> sarà anteposta</li>
<li>Questa classe sarà aggiunta al <code>corpo</code> tag Html</li></ul>
Ad esempio, il valore del campo utente <em>Blueberry Extravaganza</em> sarà slugified per essere <code>charteredcollege-pbb-blueberry-extravaganza</code><br /><br />
Questa funzione è usata insieme a <a href="https://help.blackboard.com/Blackboard_Open_LMS/Administrator/Manage_a_Site/Course_and_Site_Design/Themes/charteredcollege#advanced-branding_OTP-3" target="_blank"> CSS personalizzato</a>,
in caso occorra aggiungere selettori CSS usando le nuove classi nella sezione <a class="charteredcollege-settings-tab-link" href="#themecharteredcollegebranding">Elementi di base</a>.';
...
$string['pbb_field_description'] = 'Il valore del campo sarà slugified e usato come nome di classe CSS anteposto da <code>charteredcollege-pbb-</code>.';
...
$string['gotocalendarcharteredcollege'] = 'aprire il calendario del sito.';
...
$string['multimediacard'] = 'I file multimediali non verranno visualizzati nella scheda delle attività per il tema charteredcollege. Questo vale solo per la home page e per le pagine dei corsi per le schede delle attività e delle risorse.';
