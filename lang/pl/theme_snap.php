...
$string['choosereadme'] = '<div class="clearfix"><div class="theme_screenshot"><h2>Wykonaj migawkę</h2><img class=img-polaroid src="charteredcollege/pix/screenshot.jpg" /></div></div>';
...
$string['courseformatnotification'] = 'Aktualnie używany format kursu nie jest w pełni obsługiwany przez motyw charteredcollege. W celu uzyskania najlepszych rezultatów Open LMS zaleca stosowanie z motywem charteredcollege formatów kursu Tematy lub Tygodniowy. Format kursu można zmienić w <a href="{$a}">ustawieniach kursu</a>.';
...
$string['privacy:metadata:theme_cct_course_favorites:courseid'] = 'Identyfikator kursu, który użytkownik oznaczył jako ulubiony';
$string['privacy:metadata:theme_cct_course_favorites:userid'] = 'Identyfikator użytkownika, który oznaczył kurs jako ulubiony';
$string['privacy:metadata:theme_cct_course_favorites:timefavorited'] = 'Znacznik czasu oznaczenia przez użytkownika kursu jako ulubiony';
$string['privacy:metadata:theme_cct_course_favorites'] = 'Przechowuje ulubione kursy użytkownika na potrzeby charteredcollege';
...
$string['resourcedisplayhelp'] = 'Wybierz sposób wyświetlania załączników i łączy w kursie. Kompozycja charteredcollege nie obsługuje plików multimedialnych w opisie małych kart aktywności i zasobów.';
...
$string['showallsectionsdisabled'] = 'Ze względu na język projektu opcja „Pokaż wszystkie sekcje na jednej stronie” jest niedostępna w trybie charteredcollege.';
$string['disabled'] = 'Wyłączone';
$string['showappearancedisabled'] = 'Język projektu usługi charteredcollege uniemożliwia wprowadzanie zmian w ustawieniach „Wygląd”.';
...
<li>Jako przedrostek zostanie dołączony ciąg znaków <code>charteredcollege-pbb-</code></li>
<li>Klasa zostanie dodana do znacznika HTML <code>body</code></li></ul>
Na przykład zapisana w polu użytkownika wartość <em>Blueberry Extravaganza</em> zostanie przekształcona w <code>charteredcollege-pbb-blueberry-extravaganza</code><br /><br />
Ta funkcja jest używana w połączeniu z <a href="https://help.blackboard.com/Blackboard_Open_LMS/Administrator/Manage_a_Site/Course_and_Site_Design/Themes/charteredcollege#advanced-branding_OTP-3" target="_blank">niestandardowym arkuszem stylów CSS</a>,
selektory CSS należy dodać przy użyciu nowych klas w sekcji <a class="charteredcollege-settings-tab-link" href="#themecharteredcollegebranding">Basics</a>.';
...
$string['pbb_field_description'] = 'Wartość tego pola zostanie przekształcona w ciąg znaków bez spacji i użyta jako nazwa klasy CSS z przedrostkiem <code>charteredcollege-pbb-</code>.';
...
$string['gotocalendarcharteredcollege'] = 'przejdź do witryny kalendarza.';
...
$string['multimediacard'] = 'Pliki multimedialne nie będą wyświetlane w widokach kart aktywności w kompozycji charteredcollege. Będą one używane na stronie głównej i stronach kursu tylko w przypadku małych kart aktywności i zasobów.';
