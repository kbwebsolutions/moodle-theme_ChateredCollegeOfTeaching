...
$string['courseformatnotification'] = 'รูปแบบของรายวิชาปัจจุบันที่คุณใช้ไม่ได้รับการสนับสนุนโดยรูปแบบ charteredcollege เพื่อประสบการณ์ที่ดีที่สุดของ LMS แบบเปิด ขอแนะนำให้ใช้รูปแบบหัวข้อหรือรายสัปดาห์กับชุดรูปแบบ charteredcollege รูปแบบของรายวิชาสามารถเปลี่ยนแปลงได้ใน <a href="{$a}">การตั้งค่ารายวิชา</a>';
...
$string['privacy:metadata:theme_cct_course_favorites:courseid'] = 'ID รายวิชาของรายวิชาที่ผู้ใช้งานชื่นชอบ';
$string['privacy:metadata:theme_cct_course_favorites:userid'] = 'ID ผู้ใช้งานของผู้ใช้งานที่ชื่นชอบรายวิชา';
$string['privacy:metadata:theme_cct_course_favorites:timefavorited'] = 'เวลาประทับของเวลาที่ผู้ใช้งานชื่นชอบรายวิชา';
$string['privacy:metadata:theme_cct_course_favorites'] = 'จัดเก็บรายการโปรดของรายวิชาของผู้ใช้งานสำหรับ charteredcollege';
...
$string['resourcedisplayhelp'] = 'เลือกว่าจะให้สิ่งที่แนบและลิงก์ปรากฏในรายวิชาของคุณอย่างไร รูปแบบ charteredcollege นี้ไม่รองรับไฟล์มัลติมีเดียในคำอธิบายของกิจกรรมเล็กๆ และบัตรแหล่งข้อมููล';
...
$string['showallsectionsdisabled'] = 'เนื่องจากภาษาการออกแบบ "แสดงส่วนทั้งหมดในหน้าเดียว" ไม่พร้อมใช้งานใน charteredcollege';
$string['disabled'] = 'ปิดใช้งาน';
$string['showappearancedisabled'] = 'ภาษาการออกแบบของ charteredcollege ป้องกันการเปลี่ยนแปลงการตั้งค่า "ลักษณะ"';
...
<li>สตริง <code>charteredcollege-pbb-</code> จะได้รับการเติม</li>
<li>คลาสนี้จะถูกเพิ่มไว้ใน <code>เนื้อหา</code> แท็ก Html</li></ul>
ตัวอย่างเช่นค่าฟิลด์ผู้ใช้งาน <em>Blueberry Extravaganza</em> จะถูก slugified ให้เป็น <code>charteredcollege-pbb-blueberry-extravaganza</code><br /><br />
คุณลักษณะนี้ใช้ร่วมกับ <a href="https://help.blackboard.com/Blackboard_Open_LMS/Administrator/Manage_a_Site/Course_and_Site_Design/Themes/charteredcollege#advanced-branding_OTP-3" target="_blank"> CSS ที่กำหนดเอง</a>
คุณจะต้องเพิ่มตัวเลือก CSS โดยใช้คลาสใหม่ในส่วน <a class="charteredcollege-settings-tab-link" href="#themecharteredcollegebranding">พื้นฐาน</a>';
...
$string['pbb_field_description'] = 'ค่าของฟิลด์นี้จะได้รับการ slugified และใช้เป็นชื่อคลาส CSS ที่จัดทำขึ้นโดย <code> charteredcollege-pbb- </code>';
...
$string['gotocalendarcharteredcollege'] = 'ไปที่เว็บไซต์ของปฏิทิน';
...
$string['multimediacard'] = 'ไฟล์มัลติมีเดียจะไม่แสดงในมุมมองบัตรกิจกรรมสำหรับรูปแบบ charteredcollege วิธีการนี้จะใช้ในโฮมเพจและหน้ารายวิชาสำหรับกิจกรรมเล็กๆ และบัตรแหล่งข้อมููลเท่านั้น';
