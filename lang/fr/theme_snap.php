...
$string['cachedef_generalstaticappcache'] = 'Cache charteredcollege statique général au niveau de l\'application';
...
$string['courseformatnotification'] = 'Le format de cours que vous utilisez actuellement n\'est pas totalement pris en charge par le thème charteredcollege. Open LMS recommande d\'utiliser les formats de cours Hebdomadaire et Rubrique avec le thème charteredcollege pour bénéficier de la meilleure expérience. Le format de cours peut être modifié dans les <a href="{$a}">réglages du cours</a>.';
...
$string['privacy:metadata:theme_cct_course_favorites:courseid'] = 'Identifiant du cours que l\'utilisateur a ajouté à ses favoris';
$string['privacy:metadata:theme_cct_course_favorites:userid'] = 'Identifiant de l\'utilisateur qui a ajouté le cours à ses favoris';
$string['privacy:metadata:theme_cct_course_favorites:timefavorited'] = 'Horodatage de l\'ajout du cours aux favoris de l\'utilisateur';
$string['privacy:metadata:theme_cct_course_favorites'] = 'Enregistre les cours favoris de l\'utilisateur pour charteredcollege';
...
$string['resourcedisplayhelp'] = 'Sélectionnez le mode d\'affichage des pièces jointes et des liens dans votre cours. Le thème charteredcollege ne prend pas en charge les fichiers multimédias dans la brève description des fiches de ressources et d\'activité.';
...
$string['showallsectionsdisabled'] = 'En raison de son langage de conception, la fonctionnalité d\'affichage de l\'ensemble des sections sur une seule page n\'est pas disponible sur charteredcollege.';
$string['disabled'] = 'Désactivé';
$string['showappearancedisabled'] = 'Le langage de conception de charteredcollege empêche les modifications des paramètres d\'apparence.';
...
<li>La chaîne <code>charteredcollege-pbb-</code> est ajoutée en préfixe</li>
<li>Cette classe sera ajoutée à la balise HTML <code>body</code></li></ul>
Par exemple, <em>Blueberry Extravaganza</em> sera converti en slug de la façon suivante : <code>charteredcollege-pbb-blueberry-extravaganza</code><br /><br />
Cette fonctionnalité est utilisée en association avec <a href="https://help.blackboard.com/Blackboard_Open_LMS/Administrator/Manage_a_Site/Course_and_Site_Design/Themes/charteredcollege#advanced-branding_OTP-3" target="_blank">CSS personnalisé</a>,
vous devrez ajouter les sélecteurs CSS en utilisant les nouvelles classes de la section <a class="charteredcollege-settings-tab-link" href="#themecharteredcollegebranding">Essentiel</a>.';
...
$string['pbb_field_description'] = 'La valeur de ce champ sera convertie en slug et utilisée comme nom de classe CSS précédé de <code>charteredcollege-pbb-</code>.';
...
$string['gotocalendarcharteredcollege'] = 'accédez au calendrier du site.';
...
$string['multimediacard'] = 'Les fichiers multimédias ne s\'afficheront pas dans la fiche d\'activité pour le thème charteredcollege. Ceci sera appliqué à la page d\'accueil et aux pages de cours uniquement pour les brèves fiches de ressource et d\'activité.';
