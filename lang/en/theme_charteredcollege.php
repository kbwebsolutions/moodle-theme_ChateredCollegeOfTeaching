...
$string['cachedef_generalstaticappcache'] = 'charteredcollege general static application level cache';
...
$string['choosereadme'] = '<div class="clearfix"><div class="theme_screenshot"><h2>Chartered College</h2><img class=img-polaroid src="charteredcollege/pix/screenshot.jpg" /></div></div>';
$string['close'] = 'Close';
...
$string['courseformatnotification'] = 'The current course format you are using is not fully supported by the Chartered College theme. For the best experience Open LMS recommends using the Topics or Weekly course formats with the Chartered College theme. The course format can be changed in the <a href="{$a}">course settings</a>.';
...
$string['modulemetafielddisplay'] = 'Module Metadata field to display';
$string['modulemetafielddescription'] = 'Which Medatadata field should be shown on activity and resource cards';
$string['more'] = 'More';
...
$string['pld'] = 'PLD';
$string['pluginname'] = 'Chartered College';
...
$string['privacy:metadata:theme_cct_course_favorites:courseid'] = 'The course ID of the course that the user favorited';
$string['privacy:metadata:theme_cct_course_favorites:userid'] = 'The user ID of the user that favorited the course';
$string['privacy:metadata:theme_cct_course_favorites:timefavorited'] = 'The timestamp of when the user favorited the course';
$string['privacy:metadata:theme_cct_course_favorites'] = 'Stores users\' course favorites for Chartered College';
...
$string['resourcedisplayhelp'] = 'Select how attachments and links appear in your course. The Chartered College theme doesn\'t support multimedia files in the small activity and resource cards\' description.';
...
$string['showallsectionsdisabled'] = 'Due to its design language, "Show all sections on one page" isn\'t available in Chartered College.';
$string['disabled'] = 'Disabled';
$string['showappearancedisabled'] = 'Chartered College\'s design language prevents changes to "Appearance" settings.';
...
<li>The string <code>charteredcollege-pbb-</code> will be prepended</li>
<li>This class will be added to the <code>body</code> Html tag</li></ul>
For Example, the user field value <em>Blueberry Extravaganza</em> will be slugified to be <code>charteredcollege-pbb-blueberry-extravaganza</code><br /><br />
This feature is used in conjunction with <a href="https://help.blackboard.com/Blackboard_Open_LMS/Administrator/Manage_a_Site/Course_and_Site_Design/Themes/charteredcollege#advanced-branding_OTP-3" target="_blank">Custom CSS</a>,
you\'ll need to add CSS selectors using the new classes in the <a class="charteredcollege-settings-tab-link" href="#themecharteredcollegebranding">Basics</a> section.';
...
$string['pbb_field_description'] = 'This field\'s value will be slugified and used as a CSS class name prepended by <code>charteredcollege-pbb-</code>.';
...
$string['gotocalendarcharteredcollege'] = 'go to site calendar.';
...
$string['multimediacard'] = 'Multimedia files won\'t be displayed in the activity card views for the Chartered College theme. This will be applied in homepage and course pages only for the small activity and resource cards.';
