...
$string['courseformatnotification'] = 'The current course format you are using is not fully supported by the charteredcollege theme. For the best experience Open LMS recommends using the Topics or Weekly course formats with the charteredcollege theme. The course format can be changed in the <a href="{$a}">course settings</a>.';
...
$string['privacy:metadata:theme_cct_course_favorites'] = 'Stores users\' course favorites for charteredcollege';
...
$string['resourcedisplayhelp'] = 'Select how attachments and links appear in your course. The charteredcollege theme doesn\'t support multimedia files in the small activity and resource cards\' description.';
...
$string['showallsectionsdisabled'] = 'Due to its design language, "Show all sections on one page" isn\'t available in charteredcollege.';
$string['disabled'] = 'Disabled';
$string['showappearancedisabled'] = 'charteredcollege\'s design language prevents changes to "Appearance" settings.';
...
$string['multimediacard'] = 'Multimedia files won\'t be displayed in the activity card views for the charteredcollege theme. This will be applied in homepage and course pages only for the small activity and resource cards.';
