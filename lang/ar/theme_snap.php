...
$string['choosereadme'] = '<div class="clearfix"><div class="theme_screenshot"><h2>محاذاة</h2><img class=img-polaroid src="charteredcollege/pix/screenshot.jpg" /></div></div>';
...
$string['courseformatnotification'] = 'تنسيق المقرر الدراسي الحالي الذي تستخدمه غير مدعوم بشكل كامل من قبل سمة charteredcollege. وللحصول على أفضل تجربة، يوصي Open LMS باستخدام موضوعات أو تنسيقات المقرر الدراسي الأسبوعية مع سمة charteredcollege. يمكن تغيير تنسيق المقرر الدراسي في <a href="{$a}">إعدادات المقرر الدراسي</a>.';
...
$string['privacy:metadata:theme_cct_course_favorites:courseid'] = 'معرف المقرر الدراسي الخاص بالمقرر الدراسي الذي يفضله المستخدم';
$string['privacy:metadata:theme_cct_course_favorites:userid'] = 'معرف المستخدم الخاص بالمقرر الدراسي الذي يفضله المستخدم';
$string['privacy:metadata:theme_cct_course_favorites:timefavorited'] = 'الطابع الزمني الخاص بالمستخدم عند قيام المستخدم بتفضيل المقرر الدراسي';
$string['privacy:metadata:theme_cct_course_favorites'] = 'تخزين تفضيلات المقرر الدراسي الخاصة بالمستخدم في charteredcollege';
...
$string['resourcedisplayhelp'] = 'حدد كيفية ظهور المرفقات والروابط في مقررك الدراسي. لا تدعم السمة charteredcollege ملفات الوسائط المتعددة في وصف بطاقات الموارد والأنشطة الصغيرة.';
...
$string['showallsectionsdisabled'] = 'نظرًا للغة التصميم الخاصة بها، لا يتوفر خيار "إظهار كل الأقسام في صفحة واحدة" في charteredcollege.';
$string['disabled'] = 'مُعطَّل';
$string['showappearancedisabled'] = 'تمنع لغة تصميم charteredcollege التغييرات التي يتم إجراؤها على إعدادات "المظهر".';
...
<li>سيتم إلحاق السلسلة بـ <code>charteredcollege-pbb-</code> </li>
<li>ستتم إضافة هذه الفئة إلى <code>body</code> Html tag</li></ul>
على سبيل المثال، سيتم تغيير قيمة حقل المستخدم <em>Blueberry Extravaganza</em> لتكون <code>charteredcollege-pbb-blueberry-extravaganza</code><br /><br />
يتم استخدام هذه الميزة بالتزامن مع <a href="https://help.blackboard.com/Blackboard_Open_LMS/Administrator/Manage_a_Site/Course_and_Site_Design/Themes/charteredcollege#advanced-branding_OTP-3" target="_blank">CSS مخصصة</a>,
سيتعين عليك إضافة محددات CSS باستخدام الفئات الجديدة في قسم <a class="charteredcollege-settings-tab-link" href="#themecharteredcollegebranding">الأساسيات</a>.';
...
$string['pbb_field_description'] = 'سيتم تغيير قيمة هذا الحقل واستخدامها كاسم لفئة CSS وإلحاقها بـ <code>charteredcollege-pbb-</code>.';
...
$string['gotocalendarcharteredcollege'] = 'انتقل إلى تقويم الموقع.';
...
$string['multimediacard'] = 'لن يتم عرض ملفات الوسائط المتعددة في طرق عرض بطاقة النشاط الخاصة بالسمة charteredcollege. وسيتم تطبيق هذا في الصفحة الرئيسية وصفحات المقرر الدراسي فقط لبطاقات الموارد والأنشطة الصغيرة.';
