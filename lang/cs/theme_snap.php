...
$string['cachedef_generalstaticappcache'] = 'Obecná statická vyrovnávací paměť na úrovni aplikace charteredcollege';
...
$string['courseformatnotification'] = 'Formát kurzu, který aktuálně používáte, není motivem charteredcollege plně podporován. V zájmu optimálního chování doporučujeme u motivu charteredcollege v systému Open LMS používat formát kurzu Témata nebo Týdně. Formát kurzu lze změnit v <a href="{$a}">nastaveních kurzu</a>.';
...
$string['privacy:metadata:theme_cct_course_favorites:courseid'] = 'ID kurzu, který uživatel přidal do oblíbených';
$string['privacy:metadata:theme_cct_course_favorites:userid'] = 'ID uživatele, který kurz přidal do oblíbených';
$string['privacy:metadata:theme_cct_course_favorites:timefavorited'] = 'Časové razítko informující, kdy uživatel přidal kurz do oblíbených';
$string['privacy:metadata:theme_cct_course_favorites'] = 'Ukládá oblíbené kurzy uživatelů v motivu charteredcollege.';
...
$string['resourcedisplayhelp'] = 'Vyberte, jak se ve vašem kurzu budou zobrazovat přílohy a odkazy. Motiv charteredcollege nepodporuje multimediální soubory v popisu karet s malou aktivitou a karet zdrojů.';
...
$string['showallsectionsdisabled'] = 'V motivu charteredcollege není z důvodu charakteru návrhu k dispozici možnost Zobrazit všechna témata na stránku.';
$string['disabled'] = 'Zakázáno';
$string['showappearancedisabled'] = 'Jazyk návrhu motivu charteredcollege brání změnám nastavení Vzhled.';
...
<li>Jako předpona se připojí řetězec <code>charteredcollege-pbb-</code>.</li>
<li>Tato třída bude přidána do značky <code>body</code> jazyka HTML.</li></ul>
Hodnota uživatelského pole <em>Blueberry Extravaganza</em> bude například převedena na <code>charteredcollege-pbb-blueberry-extravaganza</code>.<br /><br />
Tato funkce se používá spolu s možností <a href="https://help.blackboard.com/Blackboard_Open_LMS/Administrator/Manage_a_Site/Course_and_Site_Design/Themes/charteredcollege#advanced-branding_OTP-3" target="_blank">Vlastní šablona stylů CSS</a>.
Bude třeba přidat selektory CSS pomocí nových tříd v sekci <a class="charteredcollege-settings-tab-link" href="#themecharteredcollegebranding">Základy</a>.';
...
$string['pbb_field_description'] = 'Hodnota tohoto pole bude „slugifikována“ a použita jako název třídy CSS s předponou <code>charteredcollege-pbb-</code>.';
...
$string['gotocalendarcharteredcollege'] = 'přejít na kalendář stránek';
...
$string['multimediacard'] = 'V motivu charteredcollege se v zobrazeních karet aktivit nezobrazí multimediální soubory. Použije se to pro domovskou stránku a stránky kurzu pouze u karet s malou aktivitou a karet zdrojů.';
