...
$string['cachedef_generalstaticappcache'] = 'charteredcollege algemene cache op statisch toepassingsniveau';
...
$string['choosereadme'] = '<div class="clearfix"><div class="theme_screenshot"><h2>charteredcollege</h2><img class=img-polaroid src="charteredcollege/pix/screenshot.jpg" />';
...
$string['courseformatnotification'] = 'De huidige cursusstructuur die je gebruikt, wordt niet volledig ondersteund door het thema charteredcollege. Voor de beste ervaring adviseert Open LMS dat je de cursusstructuur Onderwerpen of Wekelijks gebruikt met het thema charteredcollege. Je kunt de cursusstructuur wijzigen in de <a href="{$a}">cursusinstellingen</a>.';
...
$string['pld'] = 'PLD';
$string['pluginname'] = 'charteredcollege';
...
$string['privacy:metadata:theme_cct_course_favorites:courseid'] = 'De cursus-ID van de cursus die de gebruiker als favoriet heeft ingesteld';
$string['privacy:metadata:theme_cct_course_favorites:userid'] = 'De gebruikers-ID van de gebruiker die de cursus als favoriet heeft ingesteld';
$string['privacy:metadata:theme_cct_course_favorites:timefavorited'] = 'Het tijdstempel dat aangeeft wanneer de gebruiker de cursus als favoriet heeft ingesteld';
$string['privacy:metadata:theme_cct_course_favorites'] = 'Hiermee worden favoriete cursussen van gebruikers opgeslagen voor charteredcollege';
...
$string['resourcedisplayhelp'] = 'Selecteer hoe bijlagen en koppelingen in je cursus moeten worden weergegeven. Het charteredcollege-thema biedt geen ondersteuning voor multimediabestanden in de beschrijving van kleine activiteit- en bronkaarten.';
...
$string['showallsectionsdisabled'] = 'Wegens de ontwerptaal is "Toon alle secties op één pagina" niet beschikbaar in charteredcollege.';
$string['disabled'] = 'Uitgeschakeld';
$string['showappearancedisabled'] = 'De ontwerptaal van charteredcollege voorkomt wijzigingen van weergave-instellingen.';
...
<li>De tekenreeks <code>charteredcollege-pbb-</code>wordt toegevoegd als voorvoegsel</li>
<li>Deze klasse wordt toegevoegd aan de HTML-tag <code>body</code></li></ul>
De waarde <em>Blueberry Extravaganza</em> voor het gebruikersveld ziet er na slugification bijvoorbeeld uit als <code>charteredcollege-pbb-blueberry-extravaganza</code><br /><br />
Deze functie wordt gebruikt in combinatie met <a href="https://help.blackboard.com/Blackboard_Open_LMS/Administrator/Manage_a_Site/Course_and_Site_Design/Themes/charteredcollege#advanced-branding_OTP-3" target="_blank">aangepaste CSS</a>.
Je moet CSS-selectors toevoegen met behulp van de nieuwe klassen in het gedeelte <a class="charteredcollege-settings-tab-link" href="#themecharteredcollegebranding">Basisinstellingen</a>.';
...
$string['pbb_field_description'] = 'Er wordt slugification toegepast op de waarde van dit veld, waarna de waarde wordt gebruikt als de naam van een CSS-klasse voorafgegaan door <code>charteredcollege-pbb-</code>.';
...
$string['gotocalendarcharteredcollege'] = 'ga je naar de agenda van de site.';
...
$string['multimediacard'] = 'Multimediabestanden worden niet weergegeven in de activiteitkaartweergaven voor het charteredcollege-thema. Dit wordt alleen toegepast op de startpagina en cursuspagina\'s voor kleine activiteit- en bronkaarten.';
