...
$string['courseformatnotification'] = '現在お使いのコース形式はcharteredcollegeテーマでは完全にサポートされていません。Open LMSで最高のエクスペリエンスを実現するには、トピックまたは週次コースの形式をcharteredcollegeテーマと共に使用することをお勧めします。コース形式は<a href="{$a}">コース設定</a>で変更できます。';
...
$string['privacy:metadata:theme_cct_course_favorites:courseid'] = 'ユーザがお気に入りとしてマークしたコースのコースID';
$string['privacy:metadata:theme_cct_course_favorites:userid'] = 'コースをお気に入りにマークしたユーザのユーザID';
$string['privacy:metadata:theme_cct_course_favorites:timefavorited'] = 'ユーザがコースをお気に入りとしてマークしたときのタイムスタンプ';
$string['privacy:metadata:theme_cct_course_favorites'] = 'charteredcollegeのユーザのコースのお気に入りを保存します';
...
$string['resourcedisplayhelp'] = '添付ファイルとリンクをコースにどのように表示するか選択します。charteredcollegeテーマでは、小さいアクティビティとリソースカードの説明にあるマルチメディアファイルをサポートしていません。';
...
$string['showallsectionsdisabled'] = 'デザイン言語のため、charteredcollegeでは「1ページにすべてのセクションを表示する」は利用できません。';
$string['disabled'] = '無効にされています';
$string['showappearancedisabled'] = 'charteredcollegeの設計言語は"アピアランス"設定の変更を防ぎます。';
...
<li>文字列「<code>charteredcollege-pbb-</code>」が先頭に追加されます</li>
<li>このクラスは<code>body</code> HTMLタグに追加されます</li></ul>
たとえば、ユーザフィールド値<em>Blueberry Extravaganza</em>はスラッグ化されて次のように変換されます : <code>charteredcollege-pbb-blueberry-extravaganza</code><br /><br />
この機能は<a href="https://help.blackboard.com/Blackboard_Open_LMS/Administrator/Manage_a_Site/Course_and_Site_Design/Themes/charteredcollege#advanced-branding_OTP-3" target="_blank">Custom CSS</a>と組み合わせて使用され、
<a class="charteredcollege-settings-tab-link" href="#themecharteredcollegebranding">基本</a>セクションの新しいクラスを使用してCSSセレクタを追加する必要があります。';
...
$string['pbb_field_description'] = 'このフィールドの値はスラッグ化され、<code>charteredcollege-pbb-</code>が先頭に追加されたCSSクラス名として使用されます。';
...
$string['gotocalendarcharteredcollege'] = 'サイトカレンダーに移動します。';
...
$string['multimediacard'] = 'マルチメディアファイルは、charteredcollegeテーマのアクティビティカード表示では表示されません。これは小さいアクティビティとリソースカードのホームページとコースページにのみ適用されます。';
