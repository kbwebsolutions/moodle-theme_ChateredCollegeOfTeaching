...
$string['choosereadme'] = '<div class="clearfix"><div class="theme_screenshot"><h2>Fastgør</h2><img class=img-polaroid src="charteredcollege/pix/screenshot.jpg" /></div></div>';
...
$string['courseformatnotification'] = 'Det aktuelle kursusformat, som du bruger, understøttes ikke fuldt af charteredcollege-temaet. For at få den bedste oplevelse, anbefaler Open LMS at bruge kursusformaterne "Emner" eller "Ugentligt" sammen med charteredcollege-temaet. Kursusformatet kan ændres i <a href="{$a}">kursusindstillingerne</a>.';
...
$string['privacy:metadata:theme_cct_course_favorites:courseid'] = 'Kursus-id\'et for det kursus, brugeren har markeret som favorit';
$string['privacy:metadata:theme_cct_course_favorites:userid'] = 'Bruger-id\'et for den bruger, der har markeret kurset om favorit';
$string['privacy:metadata:theme_cct_course_favorites:timefavorited'] = 'Tidsstemplet for, hvornår brugeren markerede kurset som favorit';
$string['privacy:metadata:theme_cct_course_favorites'] = 'Gemmer brugerens kursusfavoritter for charteredcollege';
...
$string['resourcedisplayhelp'] = 'Vælg, hvordan vedhæftede filer og links vises i dit kursus. charteredcollege-temaet understøtter ikke multimediefiler i de små aktivitets- og ressourcekorts beskrivelse.';
...
$string['showallsectionsdisabled'] = 'På grund af dens designsprog er indstillingen "Vis alle sektioner på én side" ikke tilgængelig i charteredcollege.';
$string['disabled'] = 'Deaktiveret';
$string['showappearancedisabled'] = 'charteredcolleges designsprog forhindrer ændringer i indstillinger for "udseende".';
...
<li>Strengen <code>charteredcollege-pbb-</code> vil blive sat forrest</li>
<li>Denne klasse vil blive føjet til <code>brødtekstens</code> html-kode</li></ul>
For eksempel vil brugerfeltsværdien <em>Blueberry Extravaganza</em> blive gjort læsbart til at være <code>charteredcollege-pbb-blueberry-extravaganza</code><br /><br />
Denne funktion bruges sammen med <a href="https://help.blackboard.com/Blackboard_Open_LMS/Administrator/Manage_a_Site/Course_and_Site_Design/Themes/charteredcollege#advanced-branding_OTP-3" target="_blank">Custom CSS</a>,
Du skal tilføje CSS-vælgere ved hjælp af den nye klasse i sektionen <a class="charteredcollege-settings-tab-link" href="#themecharteredcollegebranding">Grundlæggende</a>.';
...
$string['pbb_field_description'] = 'Feltets værdi vil blive gjort læsbart og brugt som et CSS-klassenavn stillet forrest efter <code>charteredcollege-pbb-</code>.';
...
$string['gotocalendarcharteredcollege'] = 'skal du gå til webstedets kalender.';
...
$string['multimediacard'] = 'Multimediefiler vil ikke blive vist i aktivitetskortvisninger for charteredcollege-temaet. Dette vil kun være gældende på hjemmesiden og kursussiden for små aktivitets- og ressourcekort.';
