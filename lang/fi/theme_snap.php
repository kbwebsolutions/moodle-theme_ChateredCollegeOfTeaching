...
$string['cachedef_generalstaticappcache'] = 'charteredcollegein yleinen kiinteä sovellustason välimuisti';
...
$string['courseformatnotification'] = 'charteredcollege-teema ei tue täysin käyttämääsi nykyistä kurssimuotoa. Jotta voit käyttää Open LMS:ää parhaalla mahdollisella tavalla, suosittelemme, että käytät charteredcollege-teemassa Aiheet- tai Viikoittainen-kurssimuotoa. Voit vaihtaa kurssimuotoa <a href="{$a}">kurssin asetuksissa</a>.';
...
$string['privacy:metadata:theme_cct_course_favorites:courseid'] = 'Käyttäjän suosikkeihin lisäämän kurssin tunnus';
$string['privacy:metadata:theme_cct_course_favorites:userid'] = 'Suosikkeihin kurssin lisänneen käyttäjän käyttäjätunnus';
$string['privacy:metadata:theme_cct_course_favorites:timefavorited'] = 'Aikaleima, joka näyttää, milloin käyttäjä lisäsi kurssin suosikkeihin';
$string['privacy:metadata:theme_cct_course_favorites'] = 'Tallentaa käyttäjän kurssisuosikit charteredcollegeissa';
...
$string['resourcedisplayhelp'] = 'Valitse, miten liitteet ja linkit näytetään kurssilla. charteredcollege-teema ei tue multimediatiedostoja pienissä aktiviteeteissa ja aineistokorttien kuvauksissa.';
...
$string['showallsectionsdisabled'] = 'Design-kielen takia "Näytä kaikki osiot yhdellä sivulla" ei ole käytettävissä charteredcollegeissa.';
$string['disabled'] = 'Ei käytössä';
$string['showappearancedisabled'] = 'charteredcollegein suunnittelukieli estää muutokset ulkoasuasetuksiin.';
...
<li>Merkkijono <code>charteredcollege-pbb-</code> liitetään eteen.</li>
<li>Tämä luokka lisätään HTML-tunnisteeseen <code>body</code>.</li></ul>
Jos käyttäjäkentän arvo on esimerkiksi <em>Blueberry Extravaganza</em>, muuntamisen jälkeen se on <code>charteredcollege-pbb-blueberry-extravaganza</code>.<br /><br />
Tätä toimintoa käytetään yhdessä <a href="https://help.blackboard.com/Blackboard_Open_LMS/Administrator/Manage_a_Site/Course_and_Site_Design/Themes/charteredcollege#advanced-branding_OTP-3" target="_blank">mukautetun CSS:n</a> kanssa,
joten sinun täytyy lisätä CSS-valitsimet <a class="charteredcollege-settings-tab-link" href="#themecharteredcollegebranding">perusteiden</a> osion uusilla luokilla.';
...
$string['pbb_field_description'] = 'Tämän kentän arvo muunnetaan ja sitä käytetään CSS-luokan nimenä siten, että sen eteen lisätään <code>charteredcollege-pbb-</code>.';
...
$string['gotocalendarcharteredcollege'] = 'siirry sivuston kalenteriin.';
...
$string['multimediacard'] = 'Multimediatiedostoja ei näytetä charteredcollege-teeman aktiviteettikorttinäkymissä. Tätä käytetään vain aloitussivulla ja kurssisivuilla vian pienissä aktiviteeteissa ja aineistokorteissa.';
