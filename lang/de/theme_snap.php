...
$string['cachedef_generalstaticappcache'] = 'Allgemeiner statischer charteredcollege-Cache auf Anwendungsebene';
...
$string['choosereadme'] = '<div class="clearfix"><div class="theme_screenshot"><h2>charteredcollege</h2><img class=img-polaroid src="charteredcollege/pix/screenshot.jpg" /></div></div>';
...
$string['courseformatnotification'] = 'Das momentan von Ihnen genutzte Kursformat wird nicht vollständig vom charteredcollege-Thema unterstützt. Für eine bestmögliche Erfahrung empfiehlt Open LMS die Kursformate "Themen" oder "Wöchentlich" mit dem charteredcollege-Thema. Das Kursformat kann unter <a href="{$a}">Kurseinstellungen</a> geändert werden.';
...
$string['privacy:metadata:theme_cct_course_favorites:courseid'] = 'Die Kurs-ID des Kurses, den der/die Nutzer/in bevorzugt hat';
$string['privacy:metadata:theme_cct_course_favorites:userid'] = 'Die Nutzer-ID des Nutzers/der Nutzerin, der/die den Kurs bevorzugt hat';
$string['privacy:metadata:theme_cct_course_favorites:timefavorited'] = 'Der Zeitstempel des Zeitpunkts, zu dem der/die Nutzer/in den Kurs bevorzugt hat';
$string['privacy:metadata:theme_cct_course_favorites'] = 'Speichert die Kursfavoriten der Nutzer/innen für charteredcollege';
...
$string['resourcedisplayhelp'] = 'Wählen Sie aus, welche Anhänge und Links in Ihrem Kurs erscheinen sollen. Das charteredcollege-Design unterstützt keine Multimedia-Dateien in der Beschreibung der Kurzaktivitäts- und Ressourcenkarten.';
...
$string['showallsectionsdisabled'] = 'Aufgrund der Designsprache ist „Alle Abschnitte auf einer Seite anzeigen“ in charteredcollege nicht verfügbar.';
$string['disabled'] = 'Deaktiviert';
$string['showappearancedisabled'] = 'Die Designsprache von charteredcollege verhindert Änderungen an den Einstellungen von "Darstellung".';
...
<li>Die Zeichenfolge <code>charteredcollege-pbb-</code> wird der Zeichenfolge vorangestellt.</li>
<li>Diese Klasse wird dem HTML-Tag <code>body</code> hinzugefügt.</li></ul>
Beispiel: Der Nutzerfeld-Wert <em>Blueberry Extravaganza</em> wird in <code>charteredcollege-pbb-blueberry-extravaganza</code> konvertiert.<br /><br />
Diese Funktion wird zusammen mit <a href="https://help.blackboard.com/Blackboard_Open_LMS/Administrator/Manage_a_Site/Course_and_Site_Design/Themes/charteredcollege#advanced-branding_OTP-3" target="_blank">Custom CSS</a> eingesetzt.
Sie müssen CSS-Selektoren mit den neuen Klassen im Abschnitt <a class="charteredcollege-settings-tab-link" href="#themecharteredcollegebranding">Basics</a> hinzufügen.';
...
$string['pbb_field_description'] = 'Der Wert dieses Felds wird konvertiert und als CSS-Klassenname mit vorangestelltem <code>charteredcollege-pbb-</code> verwendet.';
...
$string['gotocalendarcharteredcollege'] = 'rufen Sie den Website-Kalender auf.';
...
$string['multimediacard'] = 'Multimedia-Dateien werden in den Aktivitätskarten-Ansichten für das charteredcollege-Design nicht angezeigt. Diese Einstellung wird nur bei Kurzaktivitäts- und Ressourcenkarten auf der Startseite und den Kursseiten angewendet.';
