...
$string['courseformatnotification'] = 'El format actual del curs que feu servir no és totalment compatible amb el tema charteredcollege. Per a obtenir la millor experiència, Open LMS recomana utilitzar els formats de curs per Tema o Setmanals amb el tema charteredcollege. El format del curs es pot canviar als <a href="{$a}">paràmetres del curs</a>.';
...
$string['privacy:metadata:theme_cct_course_favorites:courseid'] = 'L\'ID del curs que l\'usuari ha marcat com a favorit';
$string['privacy:metadata:theme_cct_course_favorites:userid'] = 'L\'ID de l\'usuari que va marcar el curs com a favorit';
$string['privacy:metadata:theme_cct_course_favorites:timefavorited'] = 'L\'indicador de la data i l\'hora en què l\'usuari va marcar el curs com a favorit';
$string['privacy:metadata:theme_cct_course_favorites'] = 'Emmagatzema els favorits de l\'usuari per a charteredcollege';
...
$string['resourcedisplayhelp'] = 'Seleccioneu com han d\'aparèixer els fitxers adjunts i els enllaços al vostre curs. El tema charteredcollege no admet fitxers multimèdia a l\'activitat petita i la descripció de les targetes de recursos.';
...
$string['showallsectionsdisabled'] = 'Pel seu llenguatge de disseny, l\'opció "Mostra totes les seccions en una pàgina" no està disponible al tema charteredcollege.';
$string['disabled'] = 'Inhabilitat';
$string['showappearancedisabled'] = 'El llenguatge de disseny de charteredcollege impedeix que es produeixin canvis en la configuració d\'"Aparença".';
...
<li>S\'hi afegirà el prefix <code>charteredcollege-pbb-</code></li>
<li>Aquesta classe s\'afegirà a l\'etiqueta HTML <code>body</code></li></ul>
Per exemple, el valor del camp d\'usuari <em>Blueberry Extravaganza</em> se simplificarà a <code>charteredcollege-pbb-blueberry-extravaganza</code><br /><br />
Si aquesta funció es fa servir juntament amb <a href="https://help.blackboard.com/Blackboard_Open_LMS/Administrator/Manage_a_Site/Course_and_Site_Design/Themes/charteredcollege#advanced-branding_OTP-3" target="_blank">Custom CSS</a>,
haureu d\'afegir selectors CSS utilitzant les noves classes en la secció <a class="charteredcollege-settings-tab-link" href="#themecharteredcollegebranding">Basics</a>.';
...
$string['pbb_field_description'] = 'Es netejarà i simplificarà el valor del camp i es farà servir com un nom de classe CSS al qual se li anteposarà <code>charteredcollege-pbb-</code>.';
...
$string['gotocalendarcharteredcollege'] = 'aneu al calendari del lloc.';
...
$string['multimediacard'] = 'Els fitxers multimèdia no es mostraran a les visualitzacions de targeta d\'activitat per al tema charteredcollege. Això s\'aplicarà a la pàgina principal i a les pàgines del curs només per a l\'activitat petita i les targetes de recursos.';
