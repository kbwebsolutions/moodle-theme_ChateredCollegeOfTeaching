...
$string['cachedef_generalstaticappcache'] = 'Memoria caché en el nivel de aplicación estática general charteredcollege';
...
$string['courseformatnotification'] = 'El formato actual de curso no es totalmente compatible con el tema de charteredcollege. Para obtener la mejor experiencia, Open LMS recomienda utilizar los formatos de cursos Temas o Semanales con el tema de charteredcollege. El formato de curso se puede cambiar en los <a href="{$a}">ajustes del curso</a>.';
...
$string['privacy:metadata:theme_cct_course_favorites:courseid'] = 'ID del curso de preferencia del usuario';
$string['privacy:metadata:theme_cct_course_favorites:userid'] = 'ID de usuario de la persona que eligió el curso como favorito';
$string['privacy:metadata:theme_cct_course_favorites:timefavorited'] = 'Marca de tiempo que indica cuándo el usuario eligió el curso como favorito';
$string['privacy:metadata:theme_cct_course_favorites'] = 'Almacena los cursos favoritos de los usuarios para charteredcollege';
...
$string['resourcedisplayhelp'] = 'Seleccione cómo desea que aparezcan los documentos adjuntos y los enlaces en el curso. El tema charteredcollege no admite archivos multimedia en la descripción de las tarjetas de recursos y actividades menores.';
...
$string['showappearancedisabled'] = 'El lenguaje de diseño de charteredcollege evita los cambios a los ajustes de "Apariencia".';
...
<li>La cadena <code>charteredcollege-pbb-</code> se antepondrá</li>
<li>Esta clase se agregará a la etiqueta de HTML <code>body</code></li></ul>
Por ejemplo, el valor del campo de usuario <em>Blueberry Extravaganza</em> se transformará en la línea de texto <code>charteredcollege-pbb-blueberry-extravaganza</code> que formará parte de una URL identificable<br /><br />
Esta función se utiliza junto con <a href="https://help.blackboard.com/Blackboard_Open_LMS/Administrator/Manage_a_Site/Course_and_Site_Design/Themes/charteredcollege#advanced-branding_OTP-3" target="_blank">Custom CSS</a>,
por lo que tendrá que agregar selectores CSS usando las clases nuevas en la sección Aspectos básicos<a class="charteredcollege-settings-tab-link" href="#themecharteredcollegebranding"></a>.';
...
$string['pbb_field_description'] = 'Este valor del campo se convertirá en una línea de texto que formará parte de una URL identificable y se utilizará como el nombre de una clase de CSS antepuesto por <code>charteredcollege-pbb-</code>.';
...
$string['gotocalendarcharteredcollege'] = 'diríjase al calendario del sitio.';
...
$string['multimediacard'] = 'Los archivos multimedia no se mostrarán en las vistas de la tarjeta de actividades del tema charteredcollege. Esto se aplicará en la página de inicio y en las páginas del curso solo para las tarjetas de actividades y recursos menores.';
