...
$string['choosereadme'] = '<div class="clearfix"><div class="theme_screenshot"><h2>Dividir</h2><img class=img-polaroid src="charteredcollege/pix/screenshot.jpg" /></div></div>';
...
$string['courseformatnotification'] = 'O formato de curso que você está usando atualmente não é totalmente compatível com o tema charteredcollege. Para melhor experiência, o Open LMS recomenda usar os formatos de curso Tópicos ou Semanal com o tema charteredcollege. O formato do curso pode ser alterado nas <a href="{$a}">configurações do curso</a>.';
...
$string['privacy:metadata:theme_cct_course_favorites:courseid'] = 'O código do curso marcado como favorito pelo usuário';
$string['privacy:metadata:theme_cct_course_favorites:userid'] = 'O código do usuário que marcou o curso como favorito';
$string['privacy:metadata:theme_cct_course_favorites:timefavorited'] = 'O carimbo de tempo de quando o usuário marcou o curso como favorito';
$string['privacy:metadata:theme_cct_course_favorites'] = 'Armazena os favoritos do curso do usuário para o charteredcollege';
...
$string['resourcedisplayhelp'] = 'Selecione como os anexos e os links aparecem no seu curso. O tema charteredcollege não é compatível com arquivos multimídia na descrição de cartões de atividades e recursos pequenos.';
...
$string['showallsectionsdisabled'] = 'Devido à sua linguagem de design, "Mostrar todas as seções em uma página" não está disponível em charteredcollege.';
$string['disabled'] = 'Desativado';
$string['showappearancedisabled'] = 'A linguagem de desenvolvimento do charteredcollege impede alterações às configurações de "Aparência"';
...
<li>A sequência <code>charteredcollege-pbb-</code> será iniciada</li>
<li>Esta classe será adicionada à tag de HTML <code>body</code> </li></ul>
Por exemplo, o valor de campo do usuário <em>Blueberry Extravaganza</em> será reduzido para <code>charteredcollege-pbb-blueberry-extravaganza</code><br /><br />
Este recurso é usado juntamente com <a href="https://help.blackboard.com/Blackboard_Open_LMS/Administrator/Manage_a_Site/Course_and_Site_Design/Themes/charteredcollege#advanced-branding_OTP-3" target="_blank">Custom CSS</a>,
será necessário adicionar seletores CSS usando as novas classes na seção <a class="charteredcollege-settings-tab-link" href="#themecharteredcollegebranding">Basics</a>.';
...
$string['pbb_field_description'] = 'Este valor do campo será reduzido e usado como um nome de classe CSS iniciado por <code>charteredcollege-pbb-</code>.';
...
$string['gotocalendarcharteredcollege'] = 'vá para o calendário do site.';
...
$string['multimediacard'] = 'Os arquivos multimídia não serão exibidos nas visualizações dos cartões de atividades com o tema charteredcollege. Isso será aplicado na página inicial e nas páginas do curso apenas para os cartões de atividades e recursos pequenos.';
