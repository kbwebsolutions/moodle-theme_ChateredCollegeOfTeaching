...
$string['cachedef_generalstaticappcache'] = 'charteredcollege genel statik uygulama seviyesi önbelleği';
...
$string['courseformatnotification'] = 'Şu anda kullandığınız ders biçimi charteredcollege teması tarafından tam olarak desteklenmiyor. Blackboard Open LMS, en iyi deneyim için charteredcollege temasıyla birlikte Konular veya Haftalık ders biçimlerinin kullanılmasını önerir. Ders biçimi, <a href="{$a}">ders ayarları</a> içinden değiştirilebilir.';
...
$string['privacy:metadata:theme_cct_course_favorites:courseid'] = 'Kullanıcının sık kullanılanlara eklediği dersin kimliği';
$string['privacy:metadata:theme_cct_course_favorites:userid'] = 'Dersi sık kullanılanlara ekleyen kullanıcının kullanıcı kimliği';
$string['privacy:metadata:theme_cct_course_favorites:timefavorited'] = 'Kullanıcının dersi sık kullanılanlara eklediği zamanı belirten zaman damgası';
$string['privacy:metadata:theme_cct_course_favorites'] = 'Kullanıcının charteredcollege için sık kullanılanlara eklediği dersleri depolar';
...
$string['resourcedisplayhelp'] = 'Dersinizde eklerin ve bağlantıların nasıl göründüğünü seçin. charteredcollege teması, küçük etkinlik ve kaynak kartlarının açıklamasındaki multimedya dosyalarını desteklemez.';
...
$string['showallsectionsdisabled'] = 'Tasarım dili nedeniyle "Tüm bölümleri bir sayfada göster" seçeneği charteredcollege\'te kullanılamaz.';
$string['disabled'] = 'Devre Dışı';
$string['showappearancedisabled'] = 'charteredcollege\'in tasarım dili "Görünüm" ayarlarının değiştirilmesini önler.';
...
<li><code>charteredcollege-pbb-</code> dizesi başa eklenir</li>
<li>Bu sınıf <code>body</code> Html etiketine eklenir</li></ul>
Örneğin, kullanıcı alanı değeri <em>Blueberry Extravaganza</em>, <code>charteredcollege-pbb-blueberry-extravaganza</code> şeklinde dizileştirilir<br /><br />
Bu özellik <a href="https://help.blackboard.com/Blackboard_Open_LMS/Administrator/Manage_a_Site/Course_and_Site_Design/Themes/charteredcollege#advanced-branding_OTP-3" target="_blank">Özel CSS</a> ile birlikte kullanılır,
<a class="charteredcollege-settings-tab-link" href="#themecharteredcollegebranding">Temeller</a> bölümündeki yeni sınıfları kullanarak CSS seçicileri eklemeniz gerekir.';
...
$string['pbb_field_description'] = 'Bu alanın değeri dizileştirilir ve başına <code>charteredcollege-pbb-</code> eklenerek bir CSS sınıf adı olarak kullanılır.';
...
$string['gotocalendarcharteredcollege'] = 'site takvimine gidin.';
...
$string['multimediacard'] = 'charteredcollege teması için etkinlik kartı görünümlerinde multimedya dosyaları gösterilmez. Bu, ana sayfa ve ders sayfalarında yalnızca küçük etkinlik ve kaynak kartları için uygulanır.';
