...
$string['cachedef_generalstaticappcache'] = 'charteredcollege 一般靜態應用程式層級快取';
...
$string['courseformatnotification'] = 'charteredcollege 主題無法完整支援您目前使用的課程格式。為了享有最佳使用體驗，Open LMS 建議您針對 charteredcollege 主題使用「主題」或「每週」課程格式。您可以在「<a href="{$a}">課程設定</a>」中變更課程格式。';
...
$string['privacy:metadata:theme_cct_course_favorites:courseid'] = '使用者已加入常用項目之課程的課程編號';
$string['privacy:metadata:theme_cct_course_favorites:userid'] = '將課程加入常用項目之使用者的使用者編號';
$string['privacy:metadata:theme_cct_course_favorites:timefavorited'] = '使用者將課程加入常用項目時的時間戳記';
$string['privacy:metadata:theme_cct_course_favorites'] = '儲存使用者的 charteredcollege 課程常用項目';
...
$string['resourcedisplayhelp'] = '選取附件和連結在課程中顯示的方式。在小型活動和資源卡描述中，charteredcollege 主題不支援多媒體檔案。';
...
$string['showallsectionsdisabled'] = '由於設計語言的關係，無法在 charteredcollege 中使用「在一個頁面上顯示全部章節」。';
$string['disabled'] = '已停用';
$string['showappearancedisabled'] = 'charteredcollege 的設計語言會防止變更「外觀」設定。';
...
<li>前面將會加上 <code>charteredcollege-pbb-</code> 字串</li>
<li>此類別會新增至 <code>body</code> Html 標籤</li></ul>
例如，使用者欄位值 <em>Blueberry Extravaganza</em> 將被 slugified 為 <code>charteredcollege-pbb-blueberry-extravaganza</code><br /><br />
此功能與 <a href="https://help.blackboard.com/Blackboard_Open_LMS/Administrator/Manage_a_Site/Course_and_Site_Design/Themes/charteredcollege#advanced-branding_OTP-3" target="_blank">自訂 CSS</a> 搭配使用，
您將需要使用<a class="charteredcollege-settings-tab-link" href="#themecharteredcollegebranding">基本資料</a>章節中的新類別，新增 CSS 選取器。';
$string['pbb_enable'] = '啟用以資訊為基礎的品牌塑造';
$string['pbb_enable_description'] = '僅將類別新增至 body 標籤 (如果使用)。';
$string['pbb_field'] = '要使用的使用者欄位';
$string['pbb_field_description'] = '此欄位的值將被 slugified，並在前面加上 <code>charteredcollege-pbb-</code> 作為 CSS 類別名稱。';
...
$string['gotocalendarcharteredcollege'] = '請前往網站行事曆。';
...
$string['multimediacard'] = '多媒體檔案不會在 charteredcollege 主題的活動卡檢視中顯示。此設定只會套用至小型活動和資源卡的首頁和課程頁面。';
