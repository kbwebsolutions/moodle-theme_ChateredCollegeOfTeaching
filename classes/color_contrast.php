...
class color_contrast {
    ...
    public static function compare_cat_colors() {
        ...
        $catcolors = get_config('theme_charteredcollege', 'category_color');
        $catcolorelements = json_decode($catcolors);
        if ($catcolorelements === false || $catcolorelements == null) {
            return;
        }
        $iscustomnavbaron = get_config('theme_charteredcollege', 'customisenavbar');
        $iscustomnavbuttonon = get_config('theme_charteredcollege', 'customisenavbutton');
        $navbarcolorbk = get_config('theme_charteredcollege', 'navbarbg');
        $navbarbutcolorbk = get_config('theme_charteredcollege', 'navbarbuttoncolor');
    ...
    public static function compare_basics_color() {
        $basiccolor = get_config('theme_charteredcollege', 'themecolor');
    ...
    public static function compare_navbar_color() {
        $navbarcolor1 = get_config('theme_charteredcollege', 'navbarbg');
        $navbarcolor2 = get_config('theme_charteredcollege', 'navbarlink');
    ...
    public static function compare_navbarbutton_color() {
        $navbarbutcolor1 = get_config('theme_charteredcollege', 'navbarbuttoncolor');
        $navbarbutcolor2 = get_config('theme_charteredcollege', 'navbarbuttonlink');
