...
<?php
if ($tocformat && $leftnav) {
    echo '<div id="charteredcollege-course-wrapper">';
    echo '<div class="row">';
...
$output = $PAGE->get_renderer('core', 'course');
echo $output->charteredcollege_footer_alert();
...
if ($coursemainpage) {
    ...
    if (!empty($coursefooter)) { ?>
        <footer role="contentinfo" id="charteredcollege-course-footer"><?php echo $coursefooter ?></footer>
    <?php
    }
} ?>
</main>
