...
<div id="page">
    ...
    -->
        ...
        <div id="page-header" class="clearfix charteredcollege-category-header <?php echo $mastimage; ?>">
        <div class="breadcrumb-nav" aria-label="breadcrumb"><?php echo $OUTPUT->navbar($mastimage); ?></div>
            <div id="page-mast">
            <?php
                $categories = $PAGE->categories;
                if (empty($categories)) {
                    $catname = get_string('courses', 'theme_charteredcollege');
                    ...
                    if (can_edit_in_category($catid)) {
                        ...
                        $editcatagory = '<div><a href=" '.$editurl.' " class="btn btn-secondary btn-sm">'
                                .get_string('categoryedit', 'theme_charteredcollege').'</a></div>';
                    }
                    ...
                    if ($catdescription) {
                        ...
                        $catsummary = '<div class="charteredcollege-category-description">'
