...
if (substr_compare($maincontent, $lastclosetag, -strlen($lastclosetag)) !== 0) {
    $message = 'Main content does not have the expected div tag wrapping it, required for charteredcollege Site News.';
    throw new coding_exception($message);
}

// charteredcollege feature spots.
echo $this->feature_spot_cards();

// charteredcollege featured courses.
    ...
    switch ($section) {
        case FRONTPAGENEWS:
            if ($SITE->newsitems) { // Print forums only when needed
                // charteredcollege specific override.
