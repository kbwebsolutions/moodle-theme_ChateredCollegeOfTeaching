...
if (!empty($options['help'])) {
    echo "Overwrites the file lang/tr/theme_charteredcollege.php with a fixed version for tr language.
...
Example:
$ /usr/bin/php theme/charteredcollege/cli/fix_tr_lang_string.php" . PHP_EOL;
    die;
}
