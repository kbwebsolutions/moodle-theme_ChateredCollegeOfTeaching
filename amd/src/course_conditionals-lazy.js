 ...
 */
define(['jquery', 'core/ajax', 'core/notification', 'core/templates', 'theme_charteredcollege/ajax_notification'],
    function($, ajax, notification, templates, ajaxNotify) {
        ...
        var init = function(courseConfig) {
            ...
            $(document).on("charteredcollegeModuleCompletionChange",
                function() {
                    ajax.call([
                        {
                            methodname: 'theme_charteredcollege_course_completion',
                            args: {
