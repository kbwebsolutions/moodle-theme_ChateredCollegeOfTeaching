...
define(['jquery', 'core/templates'],
    function($, templates) {
        var FooterAlert = function() {
             ...
             */
            (function() {
                containerEl = $('#charteredcollege-footer-alert');
                ...
                if (containerEl.length === 0) {
                    templates.render('theme_charteredcollege/footer_alert', {})
            ...
            this.setTitle = function(titleHTML) {
                $('.charteredcollege-footer-alert-title').html(titleHTML);
                this.setSrNotice('');
            ...
            this.addAjaxLoading = function(str) {
                str = !str ? M.util.get_string('loading', 'theme_charteredcollege') : str;
                var titleEl = $('.charteredcollege-footer-alert-title');
            ...
            this.show = function(onCancel) {
                // Re-attach charteredcollege footer alert, so it appears when moving an activity or a section.
                containerEl.prependTo('section#region-main');
                containerEl.addClass('charteredcollege-footer-alert-visible');
                if (typeof (onCancel) === 'function') {
                    $('.charteredcollege-footer-alert-cancel').click(onCancel);
                    $('.charteredcollege-footer-alert-cancel').addClass('state-visible');
                } else {
                    $('.charteredcollege-footer-alert-cancel').removeClass('state-visible');
                }
            };
             ...
             */
            this.hide = function() {
                containerEl.removeClass('charteredcollege-footer-alert-visible');
                $('.charteredcollege-footer-alert-cancel').removeClass('state-visible');
                // Detach charteredcollege footer alert after cancel button (When hiding the alert).
                containerEl.detach();
            };
