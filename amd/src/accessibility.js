...
define(['jquery', 'core/str', 'core/event'],
    function($, str, Event) {
        return {
            charteredcollegeAxInit: function(localJouleGrader, allyReport, blockReports) {

                /**
                 * Module to get the strings from charteredcollege to add the aria-label attribute to new accessibility features.
                 */
                str.get_strings([
                    {key : 'accessforumstringdis', component : 'theme_charteredcollege'},
                    {key : 'accessforumstringmov', component : 'theme_charteredcollege'},
                    {key : 'calendar', component : 'calendar'},
                    {key : 'accessglobalsearchstring', component : 'theme_charteredcollege'},
                    {key : 'viewcalendar', component : 'theme_charteredcollege'},
                    {key : 'viewmyfeedback', component : 'theme_charteredcollege'},
                    {key : 'viewmessaging', component : 'theme_charteredcollege'},
                    {key : 'viewforumposts', component : 'theme_charteredcollege'},
                    {key : 'editcoursesettings', component : 'theme_charteredcollege'},
                    ...
                    {key : 'pld', component : 'theme_charteredcollege'},
                    ...
                    $('#charteredcollege-pm-updates section a.charteredcollege-personal-menu-more small:contains("' + stringsjs[4] + '")')
                        .attr("id", "charteredcollege-pm-deadline");
                    $('#charteredcollege-pm-updates section a.charteredcollege-personal-menu-more small:contains("' + stringsjs[5] + '")')
                        .attr("id", "charteredcollege-pm-feedback");
                    $('#charteredcollege-pm-updates section a.charteredcollege-personal-menu-more small:contains("' + stringsjs[6] + '")')
                        .attr("id", "charteredcollege-pm-messages");
                    $('#charteredcollege-pm-updates section a.charteredcollege-personal-menu-more small:contains("' + stringsjs[7] + '")')
                        .attr("id", "charteredcollege-pm-forum-posts");
                    ...
                    // $initaxvars in charteredcollege/classes/output/shared.php. More validations can be added if needed.
                    if (localJouleGrader) {
                ...
                $(document).ready(function() {
                    ...
                    // charteredcollege tab panels.
                    new Tabpanel("charteredcollege-pm-accessible-tab");
                ...
                /**
                 * Add needed accessibility for tabs inside charteredcollege.
