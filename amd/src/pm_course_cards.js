 ...
 */
define(['jquery', 'core/log', 'core/templates', 'theme_charteredcollege/pm_course_favorites',
    'theme_charteredcollege/model_view', 'theme_charteredcollege/ajax_notification', 'theme_charteredcollege/util',
    'theme_charteredcollege/appear'],
    function($, log, templates, courseFavorites, mview, ajaxNotify, util, appear) {
        ...
        var CourseCards = function() {
            ...
            this.applyCourseInfo = function(crsinfo) {
                ...
                templates.render('theme_charteredcollege/course_cards', [])
                    .done(function() {
            ...
            this.reqCourseInfo = function(courseids) {
                ...
                $.ajax({
                    type: "GET",
                    async: true,
                    url: M.cfg.wwwroot + '/theme/charteredcollege/rest.php?action=get_courseinfo&contextid=' + M.cfg.context,
                    data: courseiddata,
            ...
            this.applyAppearForImages = function() {
                ...
                $('#charteredcollege-pm-courses .nav-tabs .nav-link').on('click', function() {
