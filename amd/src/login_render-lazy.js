...
define(['jquery'],
    function($) {
        ...
        return {
            /**
             * charteredcollege login option render
            ...
            loginRender : function (loginrender, loginorder) {
                var show = function (render, order, cb) {
                    switch (render) {
                        case self.enabledLoginOptions['ENABLED_LOGIN_MOODLE']:
                            $('.charteredcollege-login-option').show();
                            $('#alt-login').hide();
                            cb();
                            break;
                ...
                show(loginrender, loginorder, function () {
                    $('.charteredcollege-log-in-more').hide();
                    $('.charteredcollege-log-in-more').css('visibility','hidden');
                });
            }
        };
    }
